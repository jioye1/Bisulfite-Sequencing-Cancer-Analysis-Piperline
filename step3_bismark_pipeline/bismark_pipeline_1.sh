#!/bin/bash
#SBATCH --job-name=bismark_pipeline_1
#SBATCH --output=bismark_pipeline_1-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_1/aligned"  # Adjusted to bismark_output_1
DEDUP_DIR="/scratch/jacksony/bismark_output_1/deduplicated"  # Adjusted to bismark_output_1
METH_DIR="/scratch/jacksony/bismark_output_1/methylation"  # Adjusted to bismark_output_1
HTML_DIR="/scratch/jacksony/bismark_output_1/html_files"  # Adjusted to bismark_output_1

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23279758 23279807); do
