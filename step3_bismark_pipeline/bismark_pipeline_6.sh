#!/bin/bash
#SBATCH --job-name=bismark_pipeline_6
#SBATCH --output=bismark_pipeline_6-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_6/aligned"  # Adjusted to bismark_output_6
DEDUP_DIR="/scratch/jacksony/bismark_output_6/deduplicated"  # Adjusted to bismark_output_6
METH_DIR="/scratch/jacksony/bismark_output_6/methylation"  # Adjusted to bismark_output_6
HTML_DIR="/scratch/jacksony/bismark_output_6/html_files"  # Adjusted to bismark_output_6

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23280008 23280057); do  # Adjusted range for the sixth batch of SRRs
