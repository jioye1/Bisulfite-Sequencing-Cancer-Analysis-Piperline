#!/bin/bash
#SBATCH --job-name=bismark_pipeline_8
#SBATCH --output=bismark_pipeline_8-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_8/aligned"  # Adjusted to bismark_output_8
DEDUP_DIR="/scratch/jacksony/bismark_output_8/deduplicated"  # Adjusted to bismark_output_8
METH_DIR="/scratch/jacksony/bismark_output_8/methylation"  # Adjusted to bismark_output_8
HTML_DIR="/scratch/jacksony/bismark_output_8/html_files"  # Adjusted to bismark_output_8

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23280108 23280157); do  # Adjusted range for the eighth batch of SRRs
