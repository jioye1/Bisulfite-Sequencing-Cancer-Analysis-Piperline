#!/bin/bash
#SBATCH --job-name=bismark_pipeline_2
#SBATCH --output=bismark_pipeline_2-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_2/aligned"  # Adjusted to bismark_output_2
DEDUP_DIR="/scratch/jacksony/bismark_output_2/deduplicated"  # Adjusted to bismark_output_2
METH_DIR="/scratch/jacksony/bismark_output_2/methylation"  # Adjusted to bismark_output_2
HTML_DIR="/scratch/jacksony/bismark_output_2/html_files"  # Adjusted to bismark_output_2

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23279808 23279857); do  # Adjusted range for the second batch of SRRs
