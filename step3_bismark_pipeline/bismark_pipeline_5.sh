#!/bin/bash
#SBATCH --job-name=bismark_pipeline_5
#SBATCH --output=bismark_pipeline_5-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_5/aligned"  # Adjusted to bismark_output_5
DEDUP_DIR="/scratch/jacksony/bismark_output_5/deduplicated"  # Adjusted to bismark_output_5
METH_DIR="/scratch/jacksony/bismark_output_5/methylation"  # Adjusted to bismark_output_5
HTML_DIR="/scratch/jacksony/bismark_output_5/html_files"  # Adjusted to bismark_output_5

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23279958 23280007); do  # Adjusted range for the fifth batch of SRRs
