#!/bin/bash
#SBATCH --job-name=bismark_pipeline_10
#SBATCH --output=bismark_pipeline_10-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_10/aligned"  # Adjusted to bismark_output_10
DEDUP_DIR="/scratch/jacksony/bismark_output_10/deduplicated"  # Adjusted to bismark_output_10
METH_DIR="/scratch/jacksony/bismark_output_10/methylation"  # Adjusted to bismark_output_10
HTML_DIR="/scratch/jacksony/bismark_output_10/html_files"  # Adjusted to bismark_output_10

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23280208 23280257); do  # Adjusted range for the tenth batch of SRRs
