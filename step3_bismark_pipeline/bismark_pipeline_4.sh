#!/bin/bash
#SBATCH --job-name=bismark_pipeline_4
#SBATCH --output=bismark_pipeline_4-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_4/aligned"  # Adjusted to bismark_output_4
DEDUP_DIR="/scratch/jacksony/bismark_output_4/deduplicated"  # Adjusted to bismark_output_4
METH_DIR="/scratch/jacksony/bismark_output_4/methylation"  # Adjusted to bismark_output_4
HTML_DIR="/scratch/jacksony/bismark_output_4/html_files"  # Adjusted to bismark_output_4

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23279908 23279957); do  # Adjusted range for the fourth batch of SRRs
