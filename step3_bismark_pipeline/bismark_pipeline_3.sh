#!/bin/bash
#SBATCH --job-name=bismark_pipeline_3
#SBATCH --output=bismark_pipeline_3-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_3/aligned"  # Adjusted to bismark_output_3
DEDUP_DIR="/scratch/jacksony/bismark_output_3/deduplicated"  # Adjusted to bismark_output_3
METH_DIR="/scratch/jacksony/bismark_output_3/methylation"  # Adjusted to bismark_output_3
HTML_DIR="/scratch/jacksony/bismark_output_3/html_files"  # Adjusted to bismark_output_3

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23279858 23279907); do  # Adjusted range for the third batch of SRRs
