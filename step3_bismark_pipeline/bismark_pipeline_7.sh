#!/bin/bash
#SBATCH --job-name=bismark_pipeline_7
#SBATCH --output=bismark_pipeline_7-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_7/aligned"  # Adjusted to bismark_output_7
DEDUP_DIR="/scratch/jacksony/bismark_output_7/deduplicated"  # Adjusted to bismark_output_7
METH_DIR="/scratch/jacksony/bismark_output_7/methylation"  # Adjusted to bismark_output_7
HTML_DIR="/scratch/jacksony/bismark_output_7/html_files"  # Adjusted to bismark_output_7

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23280058 23280107); do  # Adjusted range for the seventh batch of SRRs
