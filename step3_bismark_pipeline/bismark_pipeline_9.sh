#!/bin/bash
#SBATCH --job-name=bismark_pipeline_9
#SBATCH --output=bismark_pipeline_9-%j.out
...
ALIGN_DIR="/scratch/jacksony/bismark_output_9/aligned"  # Adjusted to bismark_output_9
DEDUP_DIR="/scratch/jacksony/bismark_output_9/deduplicated"  # Adjusted to bismark_output_9
METH_DIR="/scratch/jacksony/bismark_output_9/methylation"  # Adjusted to bismark_output_9
HTML_DIR="/scratch/jacksony/bismark_output_9/html_files"  # Adjusted to bismark_output_9

mkdir -p $ALIGN_DIR $DEDUP_DIR $METH_DIR $HTML_DIR

for i in $(seq 23280158 23280207); do  # Adjusted range for the ninth batch of SRRs
